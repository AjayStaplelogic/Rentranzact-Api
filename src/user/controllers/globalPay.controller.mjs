...
import { addToWallet, payViaGlobalPayService } from "../services/globalPay.service.mjs";
...
// Decrypt webhook body comes from global pa
const decryptPayload = (cipherText, keyText) => {
    try {
...
export const globalPayWebhook = async (req, res) => {
    try {
        ...
        if (data && data.TransactionReference) {
            ...
            // Normalize data according to unified transaction method
