...
import { addRentApplication, rentApplications, rentApplicationUpdate, getRentApplications, rentApplicationsByID, editRentApplication } from "../controllers/rentApplication.controller.mjs";
