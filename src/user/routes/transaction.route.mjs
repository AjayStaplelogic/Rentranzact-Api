...
import { myTransaction, transactionById, getAllRentTransactions, downloadTransactionPdf, adminDownloadTransactionPdf } from '../controllers/transaction.controller.mjs';
...
router.get('/admin/transactions/download', adminDownloadTransactionPdf);
