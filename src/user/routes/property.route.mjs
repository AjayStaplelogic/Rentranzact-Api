 ...
 async (req, res) => {
    ...
    // req.files.forEach(async (file) => {
      ...
      if (file.mimetype.startsWith("image/")) {
        ...
        const thumbnail_path = `uploads/${req.PropertyID.toString()}/images/thumbnails/${randomFileName}`;
        const compressed_path = `uploads/${req.PropertyID.toString()}/images/compressed/${randomFileName}`;
